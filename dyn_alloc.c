// dyn_alloc.c - dynamic array of things allocator
...
extern int debuglevel;		// -v lvl: defines the level of verbosity for debugging


/*
 * Forward static function declarations
 */
static int sum_will_overflow_long(long int si_a, long int si_b);
static int multiplication_will_overflow_long(long int si_a, long int si_b);
